...
const timelineEvents = [
  ...
  },
  {
    ...
    org: "Participant · Microsoft & CGI, Bangalore",
    description: "Attended the Future Ready AI Summit at CGI, Bangalore — an industry gathering focused on AI product development, hosted by Microsoft and CGI.",
    type: "education",
  ...
  },
  {
    ...
    description: "Shortlisted as a National Finalist for the Handloom Hackathon 2025 at IIT Delhi — organised by Ministry of Textiles & DCHB.",
    type: "achievement",
    color: "#e879f9",
  ...
  },
  {
    ...
    org: "Participant",
    description: "Participated in the NASA Space Apps Challenge 2025, one of the world's largest hackathons.",
    type: "achievement",
    color: "#e879f9",
  ...
  },
  {
    ...
    org: "Seventh-day Adventist Matriculation Higher Secondary School, Madurai",
    description: "Completed Higher Secondary education with a percentage of 71.83%.",
    type: "education",
    color: "var(--accent-cyan)",
    image: "",
    images: [] as string[],
